...
public class Fields {
    ...
    public void draw(Canvas canvas) {
        ...
        // 근경
        canvas.drawBitmap(near[nearNum1], -ofsNear, h / 2, null);
        canvas.drawBitmap(near[nearNum2], w - ofsNear, h / 2, null);
    }
    ...
    private void makeBitmap(Context context) {
        ...
        for (int i = 0; i < 2; i++) {
            ...
            far[i] = Bitmap.createScaledBitmap(tmp, w, (int) (h * 0.6f), true);
        }
